    ...
    <footer class="footer">
      <div>
        <a 
          ...
          target="_blank" 
          class="icon github-icon">Github</a>
        <div class="fill" />
        <div >
          <div class="copyright">Created by <a href="https://lindgr3n.com">Johan Lindgren</a> &copy; {{ new Date().getFullYear() }}</div>
          <div>Inspired by <a href="https://whatwebcando.today/">WhatWebCanDo</a></div>
        </div>
      </div>
    </footer>
  </div>
